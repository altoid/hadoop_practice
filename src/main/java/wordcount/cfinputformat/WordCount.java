...
public class WordCount {
	...
	public static void main(String[] args) throws Exception {
		...
		/*
		 * The expected command-line arguments are the paths containing input and output data. Terminate the job if the number of
		...
		job.setInputFormatClass(WCCFInputFormat.class);

		/*
		 * For the word count application, the input file and output files are in text format - the default format.
		 * 
		 * In text format files, each record is a line delineated by a by a line terminator.
		 * 
		 * When you use other input formats, you must call the SetInputFormatClass method. When you use other output formats, you
		 * must call the setOutputFormatClass method.
		 */

		/*
		 * For the word count application, the mapper's output keys and values have the same data types as the reducer's output
		 * keys and values: Text and IntWritable.
		 * 
		 * When they are not the same data types, you must call the setMapOutputKeyClass and setMapOutputValueClass methods.
		 */
